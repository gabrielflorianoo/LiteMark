globalThis.nodeRequire = require;(globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'] = {__FARM_TARGET_ENV__: 'node'};function _interop_require_default(obj) {
...
var electron_preload_scripts_filename='';globalThis['__' + 'filename']=electron_preload_scripts_filename;var __farm_external_module_electron = require("electron");(globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'].__farm_module_system__.setExternalModules({"electron": __farm_external_module_electron});(function(_){for(var r in _){_[r].__farm_resource_pot__='file://'+__filename;(globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'].__farm_module_system__.register(r,_[r])}})({"9ccb7201":function  (module, exports, farmRequire, farmDynamicRequire) {
    module._m(exports);
    var _f_electron = farmRequire('electron');
    _f_electron.contextBridge.exposeInMainWorld('ipcRenderer', {
        on (...args) {
            const [channel, listener] = args;
            return _f_electron.ipcRenderer.on(channel, (event, ...args)=>listener(event, ...args));
        },
        off (...args) {
            const [channel, ...omit] = args;
            return _f_electron.ipcRenderer.off(channel, ...omit);
        },
        send (...args) {
            const [channel, ...omit] = args;
            return _f_electron.ipcRenderer.send(channel, ...omit);
        },
        invoke (...args) {
            const [channel, ...omit] = args;
            return _f_electron.ipcRenderer.invoke(channel, ...omit);
        }
    });
}
,});(globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'].__farm_module_system__.setInitialLoadedResources([]);(globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'].__farm_module_system__.setDynamicModuleResourcesMap({  });var farmModuleSystem = (globalThis || window || global)['55680ffc81bc862e132f86b47e33d6e6'].__farm_module_system__;farmModuleSystem.bootstrap();var entry = farmModuleSystem.require("9ccb7201");
